...
public class smallteleop extends LinearOpMode {
    //motors
...
//Initialize Drive Motors
        ...
        UpsiesMotor= hardwareMap.dcMotor.get("pickUpMotor");
        //liftLeft = hardwareMap.dcMotor.get("liftLeft");
      //  liftRight = hardwareMap.dcMotor.get("liftRight");""
//declare arm servo
...
//2
        ...
        while (opModeIsActive()) {
            ...
            liftLeft.setPower(hang);
            liftRight.setPower(-hang);
            UpsiesMotor.setPower(lift*0.75);
